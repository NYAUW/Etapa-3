package br.com.contmatic.cadastro;
...
public class CadastroTest {
    ...
    public void deve_armazenar_entrada_de_dados_de_nome_correto_simulando_o_comportamento_do_usuario() {
        ...
        assertFalse(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator.getNome()));
    }
    ...
    public void deve_verificar_entrada_senha() {
        Cadastro cadastroValidator = randomObject.cadastroRandomizer();
        assertFalse(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator.getSenha()));
    }
    ...
    public void deve_armazenar_entrada_de_dados_de_nome_incorreto_maior_que_50_simulando_o_comportamento_do_usuario() {
        ...
        assertFalse(Boolean.TRUE.equals(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator.getNome())));
    }
    ...
    public void deve_armazenar_entrada_de_dados_de_email_correto_simulando_o_comportamento_do_usuario() {
        ...
        assertFalse(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator.getEmail()));
    }
    ...
    public void deve_simuloar_entrada_usuario_no_email_sem_dominio() {
        ...
        assertTrue(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator));
    }
    ...
    public void deve_armazenar_entrada_de_dados_cpf() {
        Cadastro cadastroValidator = randomObject.cadastroRandomizer();
        assertFalse(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator.getCpf()));
    }
    ...
    public void deve_armazenar_entrada_de_dados_rg() {
        ...
        assertFalse(ValidadorAnnotations.returnAnnotationMsgError(cadastroValidator.getRg()));
    }
